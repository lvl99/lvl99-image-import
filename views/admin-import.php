...
<div class="wrap">
  ...
  <div class="lvl99-plugin-page">
    ...
    <div class="lvl99-plugin-intro">
      <?php echo sprintf( __('Scanning found <b>%d image references</b> to %s within <b>%d posts</b>', $textdomain), count($images), ($importtype == 'medialibrary' ? __('import', $textdomain) : __('change', $textdomain)), count($posts_affected) ); ?>
    </div>
      ...
      <form method="post">
        ...
        <div class="lvl99-image-import-filters-applied">
          <h4>Filters applied <button class="button button-secondary button-small">Edit filters</button></h4>
          <ul class="lvl99-image-import-filters-list">
            ...
            <li class="lvl99-image-import-filter-applied lvl99-image-import-filter-applied-<?php echo esc_attr($filter['method']); ?>">
              <input type="hidden" name="<?php echo esc_attr($textdomain); ?>_filters[$num][method]" value="<?php echo esc_attr($filter['method']); ?>" />
              <input type="hidden" name="<?php echo esc_attr($textdomain); ?>_filters[$num][input]" value="<?php echo esc_attr($filter['input']); ?>" />
              <input type="hidden" name="<?php echo esc_attr($textdomain); ?>_filters[$num][output]" value="<?php echo esc_attr($filter['output']); ?>" />
